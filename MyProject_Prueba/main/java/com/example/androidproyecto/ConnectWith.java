...
import com.example.androidproyecto.bluetooth.BluetoothAdmin;
import com.example.androidproyecto.bluetooth.BluetoothDeviceArrayAdapter;
import com.example.androidproyecto.bluetooth.BluetoothService;

import java.util.ArrayList;

public class ConnectWith extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.connectivity_bluetooth);
        ...
        String[] perms = {"android.permission.ACCESS_FINE_LOCATION", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.BLUETOOTH", "android.permission.BLUETOOTH_ADMIN", "android.permission.BLUETOOTH_CONNECT"};
        ...
        lvDispositivos.setOnItemClickListener(new ListView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent localIntent = new Intent(Constantes.BROADCAST_ACTION); // Puts the status into the  Broadcasts
                localIntent.putExtra(Constantes.TAG_STATUS, bluetoothDevice); // the Intent to receivers in this app
    ...
    private final BroadcastReceiver bReceiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            else if (BluetoothDevice.ACTION_FOUND.equals(action))
            {
                ...
                @SuppressLint("MissingPermission") String descripcionDispositivo = dispositivo.getName() + " [" + dispositivo.getAddress() + "]";
    ...
    public void onClick(View v) {
        ...
        } else if (viewId == R.id.btnBuscarDispositivo) {
            if (arrayDevices != null) {
                arrayDevices.clear();
            }
